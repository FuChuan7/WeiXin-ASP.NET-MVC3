...
//        });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            var url;
            switch (color) {
                case 'default': url = __uri('../../lib/css/default.css'); break;
                case 'blue': url = __uri('../../lib/css/blue.css'); break;
                case 'brown': url = __uri('../../lib/css/brown.css'); break;
                case 'purple': url = __uri('../../lib/css/purple.css'); break;
                case 'grey': url = __uri('../../lib/css/grey.css'); break;
                case 'light': url = __uri('../../lib/css/light.css'); break;
            }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="' + __uri('../../lib/image/ajax-loading.gif') + '" align="">',
