...
namespace Tencent.Model
{
    public class WxUser : BaseMsg
    {
        ...
        /// </summary>
        public virtual int subscribe { set; get; }
        /// <summary>
        /// 用户的标识，对当前公众号唯一
        /// </summary>
        public virtual string openid { set; get; }
        /// <summary>
        /// 用户的昵称
        /// </summary>
        ...
        /// </summary>
        public virtual string headimgurl { set; get; }
        /// <summary>
        /// 用户关注时间，为时间戳。如果用户曾多次关注，则取最后关注时间
        /// </summary>
        public virtual string subscribe_time { set; get; }
        /// <summary>
        /// 只有在用户将公众号绑定到微信开放平台帐号后，才会出现该字段。详见：获取用户个人信息（UnionID机制）
        /// </summary>
        public virtual string unionid { set; get; }
        /// <summary>
