...
{
    public class ErrorCode : BaseMsg
    {
        public virtual int errcode { set; get; }
        public virtual string errmsg { set; get; }
        public virtual string detailMsg { set; get; }
        public String ToString1() {
            return "errcode:" + errcode + "  errmsg:" + errmsg + "  detailMsg:" + detailMsg;  
        }
