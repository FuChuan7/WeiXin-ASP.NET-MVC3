define('app/layout', function(require, exports, module){ /**
...
//        });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            var url;
            switch (color) {
                case 'default': url = '/static/lib/css/default_993e371.css'; break;
                case 'blue': url = '/static/lib/css/blue_f731d06.css'; break;
                case 'brown': url = '/static/lib/css/brown_caebf81.css'; break;
                case 'purple': url = '/static/lib/css/purple_7d47921.css'; break;
                case 'grey': url = '/static/lib/css/grey_481985a.css'; break;
                case 'light': url = '/static/lib/css/light_bb48f4c.css'; break;
            }
            $('#style_color').attr("href", url);
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="' + '/static/lib/image/ajax-loading_49963fe.gif' + '" align="">',
