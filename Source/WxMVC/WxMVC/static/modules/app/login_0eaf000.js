                ...
                submitHandler: function (form) {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.success) {
                                window.location.href = "/Home/Index" + window.location.hash;
                            } else {
...
jQuery(document).ready(function () {
    ...
    Login.init();
    $.backstretch([
		        "/static/lib/image/bg/1_5063bf4.jpg",
		        "/static/lib/image/bg/2_1a22051.jpg",
		        "/static/lib/image/bg/3_ed9e701.jpg",
		        "/static/lib/image/bg/4_05c59e2.jpg"
		        ], {
		            fade: 1000,
		            duration: 8000
		        });
