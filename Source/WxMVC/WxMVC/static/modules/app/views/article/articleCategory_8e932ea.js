...
var model = avalon.define({
    ...
    isAdd: true,
    load: function () {
        ajax.articleCategory.List(model.limit, model.currentPage).done(function (data) {
    ...
    Delete: function () {
        ajax.articleCategory.del(model.ID).done(function (data) {
            if (data.success) {
    ...
    SaveCategory: function () {
        ...
        ajax.articleCategory.save(model.ID, model.Name).done(function (data) {
            if (data.success) {
                rootVm.$alert('提示', data.msg, 'success');
                $("#Add_Book_modal").modal('hide');
                model.load();
