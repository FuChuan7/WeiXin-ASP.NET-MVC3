...
var model = avalon.define({
    ...
    load: function () {
        ajax.article.List(model.limit, model.currentPage).done(function (data) {
    ...
    loadCategory: function () {
        ajax.articleCategory.List(9999, 1).done(function (data) {
    ...
    ShowSynchronizedData: function () {
        ...
        ajax.article.SynchronizedData().done(function (data) {
            if (data.success) {
    ...
    SetCategory: function (categoryId) {
        ajax.article.SetCategory(categoryId, model.ID).done(function (data) {
            if (data.success) {
                rootVm.$alert('提示', data.msg, 'success');
                $("#ShowSetCategoryWin").modal('hide');
                model.load();
