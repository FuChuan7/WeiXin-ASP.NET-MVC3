...
var model = avalon.define({
    ...
    load: function () {
        ajax.text.List(model.limit, model.currentPage, model.categoryid).done(function (data) {
    ...
    Save: function () {
        ...
        ajax.text.save(model.currentObj.ID, model.currentObj.Title, model.currentObj.Text, model.categoryid).done(function (data) {
            if (data.success) {
    ...
    Delete: function () {
        ajax.text.Del(model.currentObj.ID).done(function (data) {
            if (data.success) {
