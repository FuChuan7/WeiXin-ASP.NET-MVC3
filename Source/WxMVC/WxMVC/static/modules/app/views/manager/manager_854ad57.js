...
var model = avalon.define({
    ...
    load: function () {
        ajax.manager.List(model.limit, model.currentPage, model.activityId, model.type).done(function (data) {
    ...
    Delete:function(){
        ajax.manager.Del(model.currentManager.ID).done(function (data) {
            if (data.success) {
