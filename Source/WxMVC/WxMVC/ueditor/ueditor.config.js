...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imagePath: PrefixUrl                   //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        //,maxImageSideLength:900                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //涂鸦图片配置区
        , scrawlUrl: "/UEditor/scrawUp"           //涂鸦上传地址
        , scrawlPath: PrefixUrl                           //图片修正地址，同imagePath

        //附件上传配置区
        , fileUrl: "/UEditor/fileUp"               //附件上传提交地址
        , filePath: PrefixUrl                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        , catcherUrl: "/UEditor/getRemoteImage"   //处理远程图片抓取的地址
        , catcherPath: PrefixUrl                  //图片修正地址，同imagePath
        ...
        , imageManagerPath: PrefixUrl                                    //图片修正地址，同imagePath
...
//        ]
         , toolbars: [
            [
                ...
                'insertimage', 'music', 'background', '|' ,'source'
                 ]
        ]
...
//        }
       ...
       // ,initialFrameWidth:745  //初始化编辑器宽度,默认1000
